...
const assignedOverviewReports: React.FC = () => {
    ...
    return (
        <Box sx={{ width: "1251px", height: "438px", borderRadius: "16px", padding: "24px", gap: "24px", backgroundColor: "#FFFFFF" }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", width: "1141px", height: "16px", paddingRight: "16px", paddingLeft: "16px", gap: "16px", alignItems:"left"}}>
                ...
                {UnassignedData.map((UnAssData) => {
                    return (
                        <Box key={UnAssData.POnumber} sx={{ backgroundColor: "#FAFAFA", width: "1203px", height: "62px", borderRadius: "8px" }}>
                            <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", width: "1100px", height: "62px", borderRadius: "8px", padding: "10px", margin: "10px" , alignItems:"left"}}>
...
export default assignedOverviewReports;
